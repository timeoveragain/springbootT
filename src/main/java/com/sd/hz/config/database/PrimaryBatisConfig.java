...
@Configuration
@MapperScan(basePackages = {"com.sd.hz.mapper.primary"},sqlSessionFactoryRef = "primarySqlSessionBean")
public class PrimaryBatisConfig {
    ...
    @Primary
    @Bean(name = "primarySqlSessionBean")
